...
def app(df, X, y):
    ...
    st.markdown(
        """
            <p style="font-size:25px">
                This app uses <b style="color:green">Random Forest Classifier</b> for the Alzheimer's Stage Detection depending on EEG Clinical Test
            </p>
    ...
    st.sidebar.markdown('''
    <ul><li><b>Mild Alzheimer</b>:  F3, F7, FC5 and P7</li>
        <li><b>Clinical Alzheimer</b>: T7, AF3 and O2</li>
        <li><b>Chronic Alzheimer</b>: FC6, AF4, F8, O1</li>
        <li><b>Severe Alzheimer</b>: AF4, F4, F8</li>              
    </ul>
...
''',unsafe_allow_html=True)
    ...
    if st.button("Predict"):
        ...
        if (F7 > 4200 and F3 > 4300 or FC5 > 4200 and P7 > 4300):
            st.warning("The person has mild Alzhiemer ")
        elif (T7 > 4300 or AF3 > 4400 and O2 > 4400):
            st.error("The person has clinical Alzhiemer")
        if(FC6 > 4200 and AF4 > 4250 and F8 > 4350 and O1 > 4500):
            st.error("The person has chronic Alzhiemer")
        if(F4 > 4500 and AF4 > 4600 and F8 > 4200):
            st.error("The person has severe Alzhiemer")
        else:
            st.success("No risk of Alzheimer, however may be still susceptible to forgetfulness due to aging.")
